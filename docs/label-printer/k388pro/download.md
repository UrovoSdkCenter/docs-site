...
K388Pro Print SDK **v2.4.0** — unified **Local + BLE** entry (`UK388PrintLibrary_v2.4.0.jar`). Files are under `downloads/k388pro/`.
...
| Path | Description |
|------|-------------|
| `SDK/UK388PrintLibrary_v2.4.0.jar` | Print library (Local + BLE) |
| `DemoCode/K388BlePrinterDemo/` | Sample Android project |
| `DemoAPK/app-debug.apk` | Installable demo APK |
| `Docs/k388-printer-2.4.0.html` | Offline API documentation (same content as the HTML above) |
