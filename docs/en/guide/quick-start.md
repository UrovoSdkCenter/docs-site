...
| SDK package | Download from the product’s [Download & Demo](/en/urovo-customer-api/download) page |

::: tip Choose the right SDK
Docs on this site are organized by capability. Pick the package that matches your scenario:

- Device / system APIs → [Urovo Device API](/en/urovo-customer-api/)
- Built-in thermal printing → [Print development](/en/printer/pos/)
- SP35 development → [SP35 development](/en/cradle/)
- Scanning → [Scanning development](/en/scanning/)
- RFID → [RFID development](/en/rfid/)
- Label printers → [Label printer development](/en/label-printer/k388pro/)
:::
...
- [Development guide and basics](/en/guide/basics): permissions, logging, debugging, and troubleshooting
- [Urovo Device API](/en/urovo-customer-api/): device and system capabilities
- [Print development](/en/printer/pos/): POS thermal printing
- [Scanning development](/en/scanning/): scanner integration
- [RFID development](/en/rfid/): inventory and tag operations
- [SP35 development](/en/cradle/): SP35 cradle unlock and control
- [Label printer development](/en/label-printer/k388pro/): K388Pro built-in / BLE printing
