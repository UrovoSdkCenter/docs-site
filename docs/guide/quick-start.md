...
| SDK 包 | 从对应产品的 [下载和 Demo](/urovo-customer-api/download) 页获取 |

::: tip 选择正确的 SDK
本站按能力拆分文档。接入前先确认业务场景，再下载对应包：

- 设备系统能力 → [Urovo 设备 API](/urovo-customer-api/)
- 内置热敏打印 → [Print 开发](/printer/pos/)
- SP35 开发 → [SP35 开发](/cradle/)
- 扫码 → [扫码开发](/scanning/)
- RFID → [RFID 开发](/rfid/)
- 贴标机 → [贴标机开发](/label-printer/k388pro/)
:::
...
- [开发指南与基础](/guide/basics)：权限、日志、调试与常见问题
- [Urovo 设备 API](/urovo-customer-api/)：设备管理与系统能力
- [Print 开发](/printer/pos/)：POS 热敏打印
- [扫码开发](/scanning/)：扫码接入
- [RFID 开发](/rfid/)：RFID 盘点与读写
- [SP35 开发](/cradle/)：SP35 底座解锁与控制
- [贴标机开发](/label-printer/k388pro/)：K388Pro 本机 / 蓝牙打印
